...
> = {
  ...
  sugar_fat_excess: {
    keywords: ['торт', 'пирожное', 'конфета', 'шоколад', 'фастфуд', 'бургер', 'пицца', 'чипсы', 'колбаса', 'жареная'],
    type: 'product',
    priority: 'high',
  ...
  protein_deficit: {
    keywords: ['курица', 'рыба', 'яйцо', 'яйца', 'творог', 'мясо', 'индейка', 'бобов', 'нут', 'чечевица', 'протеин'],
    type: 'habit',
    priority: 'high',
  ...
  snacking_overeating: {
    keywords: ['перекус', 'перекусил', 'перекусила', 'закусил', 'закусила', 'дополнительно', 'еще', 'ещё', 'второй', 'третий'],
    type: 'regimen',
    priority: 'medium',
  ...
  vegetables_fiber_deficit: {
    keywords: ['салат', 'овощи', 'огурец', 'помидор', 'капуста', 'морковь', 'шпинат', 'брокколи', 'клетчатка', 'зелень'],
    type: 'product',
    priority: 'medium',
  ...
  simple_carbs_excess: {
    keywords: ['хлеб', 'булка', 'макароны', 'рис', 'картофель', 'картошка', 'пирог', 'блины', 'варенье', 'мед', 'сахар'],
    type: 'product',
    priority: 'medium',
