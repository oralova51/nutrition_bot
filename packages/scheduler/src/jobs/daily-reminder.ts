...
const DAILY_REMINDER_TEXT =
  'Запиши в дневник, что ты съела — это поможет мне лучше понять твои привычки и дать правильные рекомендации. Напомню, что писать нужно подробно, с пометками о количестве съеденного и состава блюда. Например, я съела 2 яйца, 1 средний помидор, выпила стакан черного кофе и 10 г горького шоколада без сахара.';
