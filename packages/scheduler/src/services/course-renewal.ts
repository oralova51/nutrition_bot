...
export function buildRenewalMessage(
  ...
  return [
    `Дарим вам специальное предложение в честь завершения курса! На курс LPG (10 процедур) за вами закреплена специальная скидка ${discountPercent}%! 🎉`,
    '',
    'Продолжим вместе двигаться к вашей цели:',
