...
const ACTIVATION_SUCCESS_MESSAGE =
  'Готово, ссылка активирована! 🎉\n\n' +
  'Совсем скоро я задам несколько коротких вопросов, чтобы настроить бота под вас.';
...
const ACTIVATION_ERROR_MESSAGES: Record<ActivationErrorCode, string> = {
  ...
  ENROLLMENT_CANCELLED: 'Курс, к которому относится эта ссылка, был отменён. Обратитесь к администратору студии.',
};
