...
- [ ] Мягкая рекомендация в Telegram (без «я вижу, что сегодня ты…»)
- [ ] `Recommendation` + `Message.type=recommendation`
- [ ] Не более 2–3 рекомендаций в день
- [ ] Разовое удовольствие (пиво 1× за неделю) — только подтверждение записи
- [ ] Повтор того же класса за 7 дней — частотная рамка, не «пей воду / протеин»
