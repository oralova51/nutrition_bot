...
**Фаза 5 — Завершение:** ФТ-13 определение конца курса (Critical) · ФТ-14 итоговый отчёт клиенту и короткая сводка администратору в Telegram (Critical); топ-5 продуктов собирает AI (без воды, напитки оставляем; fallback — эвристика) · ФТ-15 запрос оценки 1-5 (High) · ФТ-16 при 1-3 звёздах — комментарий + уведомление админу (High) · ФТ-17 при 4-5 — благодарность + отзыв на 2Gis/Яндекс за бонус (High).
