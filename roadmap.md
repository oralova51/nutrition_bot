...
**Текущий фокус:** Этап 1.1 (каркас проекта) — кода в репозитории ещё нет.

- [ ] Этап 0 — Подготовка (спецификации SA: ERD, Domain, adminAPI готовы; шаг 0.5 ✓)
- [ ] Этап 1 — Каркас проекта (TS/ESLint/Prettier, БД, модели Client/Course/Enrollment/Notification/Message, логирование, health-check)
- [ ] Этап 2 — Telegram-бот минимальный (webhook/polling, /start, deep link)
- [ ] Этап 3 — Подключение клиента (3A ссылки — спец ✓; 3B онбординг+анкета; 3C настройки уведомлений)
