...
**Текущий фокус:** Этап 14 завершён (14.1–14.4). Тон рекомендаций как у диетолога: разовое удовольствие без ответа, паттерн за 7 дней — частотная рамка, без пересказа записи. Порог покрытия `npm test` прежний; eval тона — `npm run eval`.
