...
**Текущий фокус:** Этап 13 — тестовое покрытие: шаги 13.1–13.3 завершены (инфраструктура, доставка в Telegram, AI-адаптер), следующий — 13.4 (processDiaryEntry на фейковом AIEngine). Покрытие проекта: 18.8% statements. Пилот (этап 12) — go/no-go после цикла когорты.
...
- [~] Этап 13 — Тестовое покрытие (13.1–13.3 готовы: инфраструктура, доставка в Telegram, AI-адаптер; дальше по убыванию риска: дневник → API → бот → job'ы → ИИ-уточнения и eval)
