...
**Текущий фокус:** Этап 13 — тестовое покрытие: шаги 13.1–13.4 завершены (инфраструктура, доставка в Telegram, AI-адаптер, обработка дневника), следующий — 13.5 (интеграционные тесты admin/internal API на тестовой БД). Покрытие проекта: 23.7% statements. Пилот (этап 12) — go/no-go после цикла когорты.
...
- [~] Этап 13 — Тестовое покрытие (13.1–13.4 готовы: инфраструктура, доставка в Telegram, AI-адаптер, дневник; дальше по убыванию риска: API → бот → job'ы → ИИ-уточнения и eval)
