...
**Текущий фокус:** Этап 13 — тестовое покрытие: шаги 13.1 (инфраструктура) и 13.2 (доставка в Telegram) завершены, следующий — 13.3 (контрактные тесты AI-адаптера). Пилот (этап 12) — go/no-go после цикла когорты.
...
- [~] Этап 13 — Тестовое покрытие (13.1 инфраструктура и 13.2 доставка в Telegram готовы; дальше по убыванию риска: AI-адаптер → дневник → API → бот → job'ы → ИИ-уточнения и eval)
